# ticket-storm
Web app that facilitates the creation, management, and prioritization of tech support tickets. Also features account creation with back-end and databasing.
...
### Users Database (blandland_ticket_storm_users)
- **users** - User accounts with authentication data

### Tickets Database (blandland_ticket_storm_tickets)
